...
| :---------- | :------------------------------- | :--- | :----- | :---------- | :---------- |
| TASK-1301   | DB初期化・スキーマ設計             | 1.0d | 🔴高   | ⏳ 未着手    | FR-024-1,8  |
| TASK-1302   | CSV→DBマイグレーション             | 1.5d | 🔴高   | ⏳ 未着手    | FR-024-2    |
| TASK-1303   | 取引CRUD API実装                  | 1.25d | 🔴高  | ⏳ 未着手    | FR-024-3    |
| TASK-1304   | 資産CRUD API実装                  | 1.0d | 🔴高   | ⏳ 未着手    | FR-024-4    |
| TASK-1305   | 互換性レイヤー実装                 | 0.75d | 🟡中  | ⏳ 未着手    | NFR-028-032 |
| TASK-1306   | DBクエリ最適化                    | 0.5d | 🟡中   | ⏳ 未着手    | FR-024-5    |
...
- [ ] **TASK-1303**: 取引 CRUD API（1.25d）
  ...
  - GET /api/transactions/list （フィルタ対応）
...
- [ ] **TASK-1305**: 互換性レイヤー実装（0.75d）
  - DataLoader クラスを DB ラッパーに再実装
  - 既存コードへの影響最小化
  - **対応**: NFR-028-032

- [ ] **TASK-1306**: DB クエリ最適化（0.5d）
  - インデックス設計（date, category, type）
  - 集計クエリ最適化（月次/カテゴリ別）
  - クエリプラン分析
  - **対応**: FR-024-5
...
フェーズ 13 計画中（未着手）: 0.0d / 9.5d = **0% 予定** ⏳
