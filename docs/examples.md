...
```json
{
  "tool": "get_financial_independence_status",
  "arguments": {
    "period_months": 12
  }
}
...
>
> - **現在の資産**: 500万円
> - **目標資産**: 6,000万円（年間支出 240万円 × 25倍）
> - **達成予定**: あと10年（2035年）
>
> 現在のペース（月利0.5%）で資産形成が進んでいます。

### 例2: What-Ifシミュレーション

**ユーザー**: もし毎月5万円追加で貯金したら、FIREはどれくらい早まる？

**LLMの処理**:

```json
{
  "tool": "project_financial_independence_date",
  "arguments": {
    "additional_savings_per_month": 50000
  }
}
```

**LLMの応答例**:
> 毎月5万円追加投資すると、FIRE達成が **1年8ヶ月** 早まります。
>
> - **現在**: 2035年1月達成予定
> - **改善後**: 2033年5月達成予定
>
> 毎月の支出を見直して、投資額を増やすことを検討してみませんか？
...
> **削減のヒント**:
>
> 1. **通信費**: 毎月1.5万円かかっています。格安SIMへの乗り換えで月5,000円削減できる可能性があります。
> 2. **サブスクリプション**: 使っていないサービスがないか確認しましょう。
>
> 定期的な支出（固定費）を見直すのが効果的です。
